...
export const socialMediaProfiles = [
  ...
  { title: 'LinkedIn', href: 'https://www.linkedin.com/company/aboni-tech', icon: LinkedInIcon },
  { title: 'Instagram', href: 'https://instagram.com/abonitech', icon: InstagramIcon },
  { title: 'GitHub', href: 'https://github.com/aboni-tech', icon: GitHubIcon },
